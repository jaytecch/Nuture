...
import css from "./IconChildbirthEd.css";

const IconChildbirthEd = props => {
  const {
    className,
    rootClassName,
  } = props;
...
IconChildbirthEd.defaultProps = {
  className: null,
  rootClassName: null,
}

IconChildbirthEd.propTypes = {
  className: string,
  rootClassName: string,
}

export default IconChildbirthEd;
