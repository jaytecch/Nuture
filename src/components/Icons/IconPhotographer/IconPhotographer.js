...
import css from './IconPhotographer.css';

const IconPhotographer = props => {
  const {
    className,
    rootClassName
  } = props;
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      ...
      <g transform="translate(0.001 -16.46)">
        ...
        <path className={classes}
              d="M246.2,246.5a1.446,1.446,0,1,0-1.446-1.446A1.448,1.448,0,0,0,246.2,246.5Z"
...
IconPhotographer.defaultProps = {
  className: null,
  rootClassName: null,
}

IconPhotographer.propTypes = {
  className: string,
  rootClassName: string,
}

export default IconPhotographer;
