...
import css from "./IconLaborDoula.css"

const IconLaborDoula = props => {
  const {
    className,
    rootClassName,
  } = props;
    ...
    className={rootClassName}>
      <g transform="translate(0 0)">
        ...
        <g transform="translate(50.234 6.832)">
          <path className={classes}
                d="M350.95,80a1.437,1.437,0,1,0,0,2.875h.008A1.437,1.437,0,0,0,350.95,80Z"
...
IconLaborDoula.defaultProps ={
  className: null,
  rootClassName: null,
};
const { string } = PropTypes;
IconLaborDoula.propTypes = {
  className: string,
  rootClassName: string,
}

export default IconLaborDoula;
