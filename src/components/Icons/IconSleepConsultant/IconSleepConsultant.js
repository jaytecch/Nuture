...
import css from "./IconSleepConsultant.css";


const IconSleepConsultant = props => {
...
IconSleepConsultant.defaultProps = {
  className: null,
  rootClassName: null,
};
...
IconSleepConsultant.propTypes = {
  className: string,
  rootClassName: string,
};

export default IconSleepConsultant;
