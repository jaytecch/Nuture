...
import css from './IconSearchCareJob.css'

const IconSearchCareJob = props => {
  const {
    className,
  } = props;
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="91.451" height="90.903"
         viewBox="0 0 91.451 90.903" >
      <g transform="translate(-0.813 -1)">
        <path className={classes} fill="current" stroke="current"
        ...
        <path className={classes} d="M38,5h6V7H38Z" transform="translate(19.181 2)" fill="current" stroke="current"/>
        <path className={classes} d="M38,9h6v2H38Z" transform="translate(19.181 4)" fill="current" stroke="current"/>
        <path className={classes} d="M38,13h6v2H38Z" transform="translate(19.181 5.781)" fill="current" stroke="current"/>
        <path className={classes} d="M38,17h6v2H38Z" transform="translate(19.181 7.707)" fill="current" stroke="current"/>
        <path className={classes} d="M38,21h6v2H38Z" transform="translate(19.181 9.634)" fill="current" stroke="current"/>
        <path className={classes} d="M0,0H2V6H0Z" transform="translate(79.237 19.825) rotate(-77.993)" fill="current" stroke="current"/>
        <path className={classes} d="M0,0H2V6H0Z" transform="translate(78.405 25.662) rotate(-77.993)" fill="current" stroke="current"/>
        <path className={classes} d="M0,0H2V6H0Z" transform="translate(77.572 31.496) rotate(-77.993)" fill="current" stroke="current"/>
        <path className={classes} d="M0,0H2V6H0Z" transform="translate(76.741 37.334) rotate(-77.993)" fill="current" stroke="current"/>
        <path className={classes} d="M0,0H2V6H0Z" transform="translate(75.902 42.164) rotate(-77.993)" fill="current" stroke="current"/>
...
IconSearchCareJob.defaultProps = {
  className: null,
};

const { string } = PropTypes;

IconSearchCareJob.propTypes = {
  className: string,
};

export default IconSearchCareJob;
