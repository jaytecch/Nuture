  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
      ...
      <g transform="translate(-0.813 -1)">
        ...
        <path className="a" d="M38,5h6V7H38Z" transform="translate(19.181 2)"/>
        <path className="a" d="M38,9h6v2H38Z" transform="translate(19.181 4)"/>
        <path className="a" d="M38,13h6v2H38Z" transform="translate(19.181 5.781)"/>
        <path className="a" d="M38,17h6v2H38Z" transform="translate(19.181 7.707)"/>
        <path className="a" d="M38,21h6v2H38Z" transform="translate(19.181 9.634)"/>
        <path className="a" d="M0,0H2V6H0Z" transform="translate(79.237 19.825) rotate(-77.993)"/>
        <path className="a" d="M0,0H2V6H0Z" transform="translate(78.405 25.662) rotate(-77.993)"/>
        <path className="a" d="M0,0H2V6H0Z" transform="translate(77.572 31.496) rotate(-77.993)"/>
        <path className="a" d="M0,0H2V6H0Z" transform="translate(76.741 37.334) rotate(-77.993)"/>
        <path className="a" d="M0,0H2V6H0Z" transform="translate(75.902 42.164) rotate(-77.993)"/>
        <path className="a"
...
IconSearchCareJobSmall.defaultProps = { className: null, rootClassName: null, isFilled: false };

const { string } = PropTypes;

IconSearchCareJobSmall.propTypes = {
  className: string,
  rootClassName: string,
};

export default IconSearchCareJobSmall;
