...
import css from "./IconNursery.css";

const IconNursery = props => {
  const {
    className,
    rootClassName,
  } = props;
  ...
  return (
    ...
    className={rootClassName}>
      ...
      <g transform="translate(31.041 11.442)">
        <path className={classes}
              d="M253.71,107.5a1.229,1.229,0,1,1,1.215-1.049A1.241,1.241,0,0,1,253.71,107.5Z"
...
IconNursery.propTypes = {
  className: string,
  rootClassName: string,
}

export default IconNursery;
