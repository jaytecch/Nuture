...
import css from './IconPostDoula.css';

const IconPostDoula = props => {
  const {
    className,
    rootClassName,
  } = props;
  ...
  return (
    ...
    className={rootClassName}>
      ...
      <path className={classes} d="M29,14h2.142v2.142H29Z" transform="translate(-0.751 -1.149)"/>
      <path className={classes} d="M33,14h2.142v2.142H33Z" transform="translate(-0.467 -1.149)"/>
      <path className={classes}
      ...
      <path className={classes} d="M17,15h2.142v2.142H17Z" transform="translate(-1.601 -1.078)"/>
      <path className={classes} d="M45,23h2.142v2.142H45Z" transform="translate(0.384 -0.511)"/>
    </svg>
  );
};
...
IconPostDoula.defaultProps = {
  className: null,
  rootClassName: null,
}

IconPostDoula.propTypes = {
  className: string,
  rootClassName: string,
}

export default IconPostDoula;
