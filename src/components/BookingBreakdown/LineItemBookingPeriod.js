...
const BookingPeriod = props => {
  const {bookings, dateType, timeZone} = props;
...
const LineItemBookingPeriod = props => {
  const {bookings, unitType, dateType, timeZone} = props;
  ...
  const formattedBookings = bookings.map(booking => {
    ...
    return {startDate: localStartDate, endDate: endDay};
  });
