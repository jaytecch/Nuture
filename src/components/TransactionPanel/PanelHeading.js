...
export const HEADING_HIRED = 'hired';
export const HEADING_ACCEPTED = 'accepted';
export const HEADING_ACCEPTED_NO_CANCEL = 'accepted-no-cancel';
  ...
  switch (panelHeadingState) {
    ...
    case HEADING_HIRED:
      return isCustomer ? (
        <HeadingCustomer
          className={titleClasses}
          id="TransactionPanel.hiredProviderTitle"
          values={{ providerName }}
        >
          {!listingDeleted ? (
            <p className={css.transactionInfoMessage}>
        ...
        <HeadingProvider
          className={titleClasses}
          id="TransactionPanel.applyAcceptedTitle"
          values={{ customerName }}
        >
          {!isCustomerBanned ? (
            <p className={titleClasses}>
              <FormattedMessage id="TransactionPanel.hireRequestedInfo" values={{ customerName }} />
            </p>
          ) : null}
        </HeadingProvider>
      )
    ...
    case HEADING_ACCEPTED_NO_CANCEL:
      return isCustomer ? (
        <HeadingCustomer
          className={titleClasses}
          id="TransactionPanel.orderAcceptedNoCancelTitle"
          values={{ customerName, listingLink }}
        />
    ) : (
      <HeadingProvider
        className={titleClasses}
        id="TransactionPanel.saleAcceptedNoCancelTitle"
        values={{ customerName, listingLink }}
      />
    );
    ...
    default:
      console.warn('Unknown state given to panel heading: ' + panelHeadingState);
      return null;
  }
};
