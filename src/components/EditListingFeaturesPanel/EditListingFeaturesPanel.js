...
const FEATURES_NAME = 'providerStyles';
...
const EditListingFeaturesPanel = props => {
  ...
  const providerStyles = publicData && publicData.providerStyles;
  const initialValues = { providerStyles };
  ...
  return (
    <div className={classes}>
      ...
      <EditListingFeaturesForm
        ...
        onSubmit={values => {
          const { providerStyles = [] } = values;

          const updatedValues = {
            publicData: { providerStyles },
          };
