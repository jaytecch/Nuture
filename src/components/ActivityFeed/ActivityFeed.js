...
const hasUserLeftAReview = (userRole, transaction) => {
  ...
  return transitionIsReviewed(transaction);
};
...
const resolveTransitionMessage = (
  ...
  switch (currentTransition) {
    ...
    case TRANSITION_ACCEPT_HIRE_CONFIRM:
      return isOwnTransition ? (
        <FormattedMessage id="ActivityFeed.ownTransitionHireConfirm" />
      ) : (
        <FormattedMessage id="ActivityFeed.transitionConfirmed" values={{ displayName }} />
      );
    case TRANSITION_DISABLE_CANCEL:
      return <FormattedMessage id="ActivityFeed.transitionDisableCancel" />
    ...
    case TRANSITION_DECLINE_HIRE_CONFIRM:
      return isOwnTransition ? (
        <FormattedMessage id="ActivityFeed.ownTransitionHireDeclined" />
      ) : (
        <FormattedMessage id="ActivityFeed.transitionHireDeclined" values={{ displayName }} />
      );
    ...
    case TRANSITION_REVIEW:
      if (isOwnTransition) {
        ...
        const userHasLeftAReview = hasUserLeftAReview(ownRole, transaction);
