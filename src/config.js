import * as custom from './nurtureup-config.js';
...
// search off by changing the keywordFilterConfig parameter active to false in nurtureup-config.js
...
const siteTitle = 'NurtureUp';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = '@WeNurtureup';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = 'https://www.instagram.com/wenurtureup/';

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/Wenurtureup';
