...
export const ERROR_CODE_TRANSACTION_INVALID_ACTION_SEQUENCE = 'transaction-invalid-action-sequence';
...
export const ERROR_CODE_VALIDATION_DISALLOWED_KEY = 'validation-disallowed-key';
...
const ERROR_CODES = [
  ...
  ERROR_CODE_TRANSACTION_INVALID_ACTION_SEQUENCE,
  ...
  ERROR_CODE_VALIDATION_DISALLOWED_KEY,
];
