...
export const PAYOUT_REQUEST = 'app/TransactionPage/PAYOUT_REQUEST';
export const PAYOUT_SUCCESS = 'app/TransactionPage/PAYOUT_SUCCESS';
export const PAYOUT_ERROR = 'app/TransactionPage/PAYOUT_ERROR';
...
export const payoutOrDisputeInProgress = state => {
  return state.TransactionPage.payoutInProgress || state.TransactionPage.disputeInProgress;
};
...
export const acceptSale = (id, isHire = false) => (dispatch, getState, sdk) => {
...
export const declineSale = (id, isHire=false) => (dispatch, getState, sdk) => {
  if (acceptOrDeclineInProgress(getState())) {
    return Promise.reject(new Error('Accept or decline already in progress'));
  }
...
export const payout = id => (dispatch, getState, sdk) => {
