            ...
            <div>
              <div className={css.contentContainer}>
                ...
                <div className={css.mainContent}>
                  <div className={css.nameAndActionSection}>
                    <SectionHeading
                  ...
                  <SectionFeaturesMaybe options={serviceTypesConfig} publicData={publicData} />
                  <SectionMapMaybe
...
ListingPageComponent.defaultProps = {
  ...
  serviceTypesConfig: config.custom.serviceTypes,
};
