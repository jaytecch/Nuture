      ...
      <Form className={classes} onSubmit={handleSubmit}>
        ...
        <div className={css.paymentAddressField}>
          ...
          <FieldTextInput
            ...
            placeholder={billingDetailsNameLabel}
          />
        ...
        <div className={css.submitContainer}>
          ...
          <PrimaryButton
            className={css.chargeButton}
            spinnerClassName={css.spinner}
            type="submit"
            inProgress={proPaymentInProgress}
            disabled={submitDisabled}
          >
            <FormattedMessage id="PaymentMethodsForm.chargeSubscriptionFee" />
          </PrimaryButton>
        </div>
      </Form>
    ) : (
...
PaymentMethodsForm.propTypes = {
  ...
  form: object,
  proPaymentInProgress: bool,
  proPaymentError: object,
};
