...
import {Form, FieldTextInput, SecondaryButton, PrimaryButton} from '../../components';
  ...
  return (
    ...
    >
      <g fill="none" fillRule="evenodd" strokeLinejoin="round">
        <path className={css.msgIconPath} d="M12.91 1L0 7.003l5.052 2.212z"/>
        <path className={css.msgIconPath} d="M10.75 11.686L5.042 9.222l7.928-8.198z"/>
        <path className={css.msgIconPath} d="M5.417 8.583v4.695l2.273-2.852"/>
      </g>
    </svg>
  );
};
    ...
    return (
      <FinalForm
        ...
        render={formRenderProps => {
          ...
          const sendButtonText = intl.formatMessage({id: "SendMessageForm.sendMessage"})
            ...
            <Form className={classes} onSubmit={values => handleSubmit(values, form)}>
              ...
              <div className={css.submitContainer}>
                ...
                <div className={css.buttonGroup}>
                  {handleClose ? (
                    <SecondaryButton rootClassName={css.closeButton} onClick={onClose}>
                      Close
                    </SecondaryButton>
                  ) : null}
                  ...
                  <PrimaryButton
                    ...
                    onBlur={this.handleBlur}
                  >
                    <div className={css.inButton}>
                      <IconSendMessage/>
                      <span className={css.buttonText}>{sendButtonText}</span>
                    </div>
                  </PrimaryButton>
                </div>
